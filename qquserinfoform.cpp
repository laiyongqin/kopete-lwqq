/*
    qquserinfoform.cpp - QQ show user info
...
//! [0]
QQUserInfoForm::QQUserInfoForm(QQContact *contact, QWidget *parent)
    : QWidget(parent)
{
    ui.setupUi(this);
...
void QQUserInfoForm::initLabel()
{


}

QString QQUserInfoForm::shengxiaoToStr(LwqqShengxiao shengxiao)
{
    switch(shengxiao)
    {
    case LWQQ_MOUTH:
...
QString QQUserInfoForm::constellationToStr(LwqqConstel constel)
{
    switch(constel)
    {
    case LWQQ_AQUARIUS:
...
void QQUserInfoForm::setInfo(LwqqBuddy *buddy)
{
